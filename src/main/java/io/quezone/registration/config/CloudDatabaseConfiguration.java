package io.quezone.registration.config;
...
@Configuration
@EnableMongoRepositories("io.quezone.registration.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("io.quezone.registration.config.dbmigrations");
